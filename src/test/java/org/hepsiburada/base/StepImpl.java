...
public class StepImpl {
    ...
    protected void waitElement(By elementBy) {
        wait.until(ExpectedConditions.presenceOfElementLocated(elementBy));
    }

    protected void waitListElements(By elementBy) {
    ...
    protected void checkElement(By elementBy){
        checkElement(driver.findElements(elementBy));
    }
    ...
    protected void sendKey(By elementBy, String text){
        sendKey(driver.findElement(elementBy), text);
    }

    protected void sendKeyEnter(By elementBy){
    ...
    protected void clickListElementIndex(List<WebElement> elements, int index){
    ...
    protected void clickListElementIndex(By elementBy, int index){
        clickListElementIndex(driver.findElements(elementBy), index);
    }
    ...
    protected void waitClickable(By elementBy){
        waitClickable(driver.findElement(elementBy));
    }
    ...
    protected void scroll(By elementBy) {
        scroll(driver.findElement(elementBy));
    }
